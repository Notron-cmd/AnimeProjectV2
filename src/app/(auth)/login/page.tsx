        ...
        <div className="w-full max-w-md my-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="grid gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 rounded-lg border border-input bg-card py-2 text-foreground hover:bg-muted transition-colors text-sm active:scale-95 duration-150 cursor-pointer"
            >
